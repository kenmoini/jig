  ...
  <tbody role="rowrole">
    @if(count($roles))
      ...
      <tr role="row">
        ...
        <td role="cell" data-label="Actions"><a href="{{ route('panel.get.roles.edit', $role->id) }}" class="pf-c-button pf-u-display-none">Edit</a><a href="{{ route('panel.get.roles.show', $role->id) }}" class="pf-c-button">View</a></td>
      </tr>
      @endforeach
    @else
      <tr role="row">
